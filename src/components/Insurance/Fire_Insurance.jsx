        ...
        <div className="insurance-page">
          ...
          <div className="details-section">
            ...
            <ul className="insurance-list">
              <li>
                <strong>Standard Fire and Special Perils Policy:</strong> Covers
                damage caused by fire, lightning, explosion, and other specified
                perils.
              </li>
              <li>
                <strong>Valued Policy:</strong> The sum assured is fixed and
                agreed upon at the time of the policy purchase, regardless of
                the actual value of the property at the time of the claim.
              </li>
              <li>
                <strong>Floating Policy:</strong> Ideal for businesses, it
                covers multiple properties under one policy, provided the
